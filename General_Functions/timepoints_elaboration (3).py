...
def elaborate_predictions(predictions_list, test_y, results = True, beta = 1, mcc = False):
    #print(f'Atived inside elaborate_predictions')
    
    #print(f'test_y: {test_y}')
    #print(f'pred_phenotypes: {predictions_list}')
    ...
    #seeds_len = [len(s) for s in predictions_list]
    #print(f'predictions_list: {seeds_len}')
    #print(f'predictions_list: {test_y}')
